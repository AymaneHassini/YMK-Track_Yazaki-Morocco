...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('employee.store') }}" enctype="multipart/form-data" novalidate>
        	@csrf

            <h5  class="btn btn-primary rounded-pill waves-effect waves-light" style="background-color: #e60012; border-color: #e60012; color: white;"><i class="mdi mdi-account-circle me-1"></i> Add Employee</h5>
    ...
    <div class="col-md-6">
      ...
      <span class="text-danger"> {{ $message }} </span>
        ...
        <div class="mb-3">
            ...
            <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" pattern="^[a-zA-Z0-9._%+-]+@yazaki-europe\.com$" required>
             @error('email')
      <span class="text-danger"> {{ $message }} </span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" pattern="\d{10}" title="The phone number must be exactly 10 digits" required>
             @error('phone')
      <span class="text-danger"> {{ $message }} </span>
            @enderror
        </div>
