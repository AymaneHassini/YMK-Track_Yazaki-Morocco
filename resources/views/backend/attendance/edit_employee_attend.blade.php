...
<div class="content">
            ...
            <div class="page-title-box">
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     ...
                     <a href="{{ route('employee.attend.list') }}" class="btn btn-primary rounded-pill waves-effect waves-light" style="background-color: #e60012; border-color: #e60012; color: white;">
    <i class="fas fa-list me-2"></i>Employee Attendance List
</a>
                     </h4>
                  </ol>
               </div>
  ...
  <input type="date" name="date" id="date" class="checkdate form-control form-control-sm singledatepicker" value="{{ $editData['0']['date'] }}" placeholder="Attendance Date" autocomplete="off">
                     ...
                     <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                        <thead>
                           <tr>
                              <th rowspan="2" class="text-center" style="vertical-align: middle"><strong>Sl.</strong></th>
                              <th rowspan="2" class="text-center" style="vertical-align: middle"><strong>Employee name</strong></th>
                              <th colspan="3" class="text-center" style="vertical-align: middle"><strong>Attendance Status</strong></th>
                           </tr>
                           <tr>
                           <th class="text-center btn present_all" style="display: table-cell; background-color: #1c1c1c; color: white; border: none; cursor: pointer; padding: 10px;">
    Present
</th>
<th class="text-center btn leave_all" style="display: table-cell; background-color: #1c1c1c; color: white; border: none; cursor: pointer; padding: 10px;">
    Leave
</th>
<th class="text-center btn absent_all" style="display: table-cell; background-color: #1c1c1c; color: white; border: none; cursor: pointer; padding: 10px;">
    Absent
</th>
 ...
 <button type="submit" class="btn btn-primary rounded-pill waves-effect waves-light" style="background-color: #1c1c1c; border-color: #1c1c1c; color: white;"><i class="mdi mdi-content-save"></i> Update</button>
 </form>
</div>
               <!-- end card body-->
...
<script type="text/javascript">
    $(document).ready(function() {
        // Individual click handlers for 'present', 'leave', 'absent'
        ...
        // Click handlers for 'present_all', 'leave_all', 'absent_all'
