...
<div class="content">
 ...
 <button type="submit" class="btn btn-primary btn-sm rounded-pill py-2 px-4 waves-effect waves-light" style="background-color: #1c1c1c; border-color: #1c1c1c; color: white;">
