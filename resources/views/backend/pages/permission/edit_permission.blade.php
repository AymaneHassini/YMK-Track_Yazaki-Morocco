...
<div class="card">
    ...
    <div class="col-md-6">
        ...
        <option value="pos" {{ $permission->group_name == 'pos' ? 'selected' : '' }}> Point Of Sale</option>
        ...
        <option value="attendence" {{ $permission->group_name == 'attendance' ? 'selected' : '' }}> Attendance </option>
