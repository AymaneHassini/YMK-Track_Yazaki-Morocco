...
<div class="card">
 ...
 <div class="col-md-6">
        <div class="mb-3">
            ...
            <div class="text-end">
            <button type="submit" class="btn btn-primary rounded-pill waves-effect waves-light" style="background-color: #1c1c1c; border-color: #1c1c1c; color: white;"><i class="mdi mdi-content-save"></i> Complete Order</button>
            </div>
        </form>
    </div>
