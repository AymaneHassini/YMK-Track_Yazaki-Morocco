...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('advance.salary.store') }}" >
            ...
            <h5 class="btn btn-primary rounded-pill waves-effect waves-light" style="background-color: #e60012; border-color: #e60012; color: white;"><i class="mdi mdi-account-circle me-1"></i> Add Advance Salary</h5>
