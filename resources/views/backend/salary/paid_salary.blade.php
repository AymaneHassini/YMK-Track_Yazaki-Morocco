...
<div class="card">
 ...
 <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Employee Name:</label>
             <strong style="color: #6e6e6e;">{{ $paysalary->name }}</strong>
        </div>
    </div>
 ...
 <div class="col-md-6">
        <div class="mb-3">
          ...
          <strong style="color: #6e6e6e;">{{ date("F", strtotime('-1 month')) }}</strong>
      ...
      <div class="col-md-6">
        <div class="mb-3">
          ...
          <strong style="color: #6e6e6e;">{{ $paysalary->salary }}</strong>
  ...
  <div class="col-md-6">
        <div class="mb-3">
          ...
          <strong style="color: #6e6e6e;">{{ $paysalary['advance']['advance_salary'] }}</strong>
  ...
  <div class="col-md-6">
        <div class="mb-3">
          ...
          <strong style="color: #6e6e6e;"> 
            ...
            <div class="text-end">
            <button type="submit" class="btn btn-primary rounded-pill waves-effect waves-light" style="background-color: #1c1c1c; border-color: #1c1c1c; color: white;"><i class="mdi mdi-content-save"></i> Pay Salary</button>
            </div>
        </form>
    </div>
