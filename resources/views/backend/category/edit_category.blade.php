...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('category.update') }}" >
            ...
            <h5  class="btn btn-primary rounded-pill waves-effect waves-light" style="background-color: #e60012; border-color: #e60012; color: white;"><i class="mdi mdi-account-circle me-1"></i> Edit Category</h5>
