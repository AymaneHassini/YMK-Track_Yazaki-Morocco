...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('supplier.store') }}" enctype="multipart/form-data">
            ...
            <h5 class="btn btn-primary rounded-pill waves-effect waves-light" style="background-color: #e60012; border-color: #e60012; color: white;"><i class="mdi mdi-account-circle me-1"></i> Add Supplier</h5>
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="mb-3">
            <label for="firstname" class="form-label">Supplier Company Name    </label>
